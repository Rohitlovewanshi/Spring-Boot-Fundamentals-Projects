package com.rohit.rest.fileprocessing;
...
class RestFileProcessingApplicationTests {
	...
	private static final String DOWNLOAD_PATH = "/Users/rohit/Documents/Download/";
	...
	void testUpload() {
		...
		body.add("file", new ClassPathResource("rohit_photo.jpg"));
	...
	void testDownload() throws IOException {
		...
		String fileName = "rohit_photo.jpg";
